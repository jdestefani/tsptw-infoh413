...
the used seed, the number of constraints violations and the penalized relative percentage deviation.
...
\begin{itemize}
  \item $[INSTANCE\_NAME]-CpuTime.pdf$ containing the boxplots of the run-time distribution for each algorithm.
